...
<div>
  <div class="h-screen flex justify-center items-center bg-cover bg-center" style="background-image: linear-gradient(rgb(0 0 0 / 60%), rgb(0 0 0 / 60%)), url('https://assets.nflxext.com/ffe/siteui/vlv3/c0a32732-b033-43b3-be2a-8fee037a6146/2fe6e3c0-5613-4625-a0c1-3d605effd10b/IN-en-20210607-popsignuptwoweeks-perspective_alpha_website_large.jpg')">
    ...
    <div class="space-y-5 bg-gradient-to-br from-slate-900 to-pink-800 p-10 translate-x-5 transform scale-95 animate-pulse duration-500">
      <div class="text-white font-bold text-2xl md:text-5xl  flex justify-start items-center m-0 md:mx-32 flex-col">
        <span>Unlimited movies</span>
        <span>shows and more.</span>
      </div>
     
      <p class="text-white text-lg flex flex-col items-center">
      <span>Readily Performant </span>
        <span class=" text-orange-600  text-xl flex flex-col items-center font-extrabold">Search with our api.</span>
  ...
  <hr />
  <div class="h-screen flex items-center justify-center bg-black p-5 md:flex-row flex-col">
